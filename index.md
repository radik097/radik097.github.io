...
- **IT Support & Infrastructure:** Windows / Linux / macOS install & config · Networking (TCP/IP, DNS/DHCP, Wi-Fi/router) · Microsoft 365 support · Active Directory basics · Hardware & driver troubleshooting
- **Cyber Security:** Security fundamentals & OWASP awareness · Basic OSINT · Vulnerability scanning & log analysis scripting · Secure coding practices
- **Programming & Data:** Python (automation, pandas, NumPy) · JavaScript / TypeScript · SQL · Rust (foundational) · Git / GitHub
- **Web & AI:** HTML5 / CSS3, React, Vite · REST APIs · LLM integration (OpenAI, Gemini, Ollama) · Docker & containerisation
...
**IT Support & Development** — Home Lab / Self-Directed Projects
*Jan 2024 – Present*
...
- **Certificate IV in Cyber Security** — Holmesglen TAFE, Melbourne — *Currently studying*
- **Certificate III in Cyber Security** — Holmesglen TAFE, Melbourne — *Completed 2025*
- **Barista Certificate**
- **Driver's Licence (L1 Learner)** — *Currently studying*
